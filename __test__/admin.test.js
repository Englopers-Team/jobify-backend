...
describe('Admin', () => {
  ...
  it('Normal users and companies cannot access admins routes', () => {
    return mockRequest.post('/logout').then(() => {
      return mockRequest
        .post('/signin')
  ...
  it('Admins can see all post from community', () => {
    return mockRequest
      .get('/admin/posts')
      .set('Cookie', [`token=${token}`])
      .then((result) => {
  ...
  it('Admins can see certain post from community', () => {
    return mockRequest
  ...
  it('Admins can edit certain post from community', () => {
    return mockRequest
      .post('/signin')
      .send({ email: 'demop@gmail.com', password: '123456' })
      .then((result) => {
